...
if __name__ == '__main__':
    data_filepath='../mouse/input/Limb_Muscle_facts_processed_3m.h5ad'
    ...
    # print(expression_only.genes_upper)
    # print(expression_only.variable_genes_names)
    print(expression_only.exp_variable_genes)